...
- **114 server tools, 65 of them owner-gated.** Messages, DMs, members, roles, channels and their
  ...
  music with saved lists, reminders, notes and conversation summaries.
...
src/
  ...
  tools/          the 114 model-callable tools
