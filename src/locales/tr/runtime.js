...
export default {
	...
	health_summary: '[sağlık: {why}] {minutes} dk · parça {fragments} (kesin %{sure}, eğilimli %{leaning}, belirsiz %{unsure}, ses yok %{silent}) · satır {lines} (adlı %{named}, karışık %{mixed}, kimsenin değil %{unknown}) · kayma {drift} ms (en çok {driftMax})',
