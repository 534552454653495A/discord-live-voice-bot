...
export default {
	...
	health_audio: '[sağlık] ses: gönderilen/duvar saati %{ratio} · en geç tick {late} ms, toplu tick {bursts} · delik {holes} (gizlenen {concealed}), taşan kare {overflow}, en derin kuyruk {depth} kare · seviyeler: {levels}',
