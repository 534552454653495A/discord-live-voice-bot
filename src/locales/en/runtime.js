...
export default {
	...
	health_audio: '[health] audio: sent/wall clock {ratio}% · latest tick {late} ms, catch-up bursts {bursts} · holes {holes} (concealed {concealed}), frames overflowed {overflow}, deepest queue {depth} frames · levels: {levels}',
