...
export default {
	...
	health_summary: '[health: {why}] {minutes} min · fragments {fragments} (sure {sure}%, leaning {leaning}%, unsure {unsure}%, no audio {silent}%) · lines {lines} (named {named}%, mixed {mixed}%, nobody\'s {unknown}%) · drift {drift} ms (max {driftMax})',
