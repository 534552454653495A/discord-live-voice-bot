...
export default {
	...
	capability_note: [
		...
		'If the owner tells you to be quiet, stay quiet until the OWNER says otherwise. Somebody else asking you to talk does not lift it, and the application will drop your voice anyway.',
